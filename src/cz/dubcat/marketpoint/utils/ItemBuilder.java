...
public class ItemBuilder {
    ...
    public ItemBuilder name(final String name) {
        meta().setDisplayName(ColorsUtil.colorizeText(name));
    ...
    public ItemBuilder colorizeLore() {
        ...
        for (int i = 0; i < lores.size(); i++) {
            lores.set(i, ColorsUtil.colorizeText(lores.get(i)));
        }
        meta().setLore(lores);
        make().setItemMeta(meta());
        return this;
    ...
    public ItemBuilder color(final Color color) {
        if (make().getType() == XMaterial.LEATHER_HELMET.parseMaterial() || make().getType() == XMaterial.LEATHER_CHESTPLATE.parseMaterial()
                || make().getType() == XMaterial.LEATHER_LEGGINGS.parseMaterial() || make().getType() == XMaterial.LEATHER_BOOTS.parseMaterial()) {
    ...
    /**
     * Sets the skullOwner {@link SkullMeta} of the current SKULL_ITEM
     * {@link Material} type {@link ItemStack}
     *
    ...
    public ItemBuilder skullOwner(final String name) {
        if (make().getType() == XMaterial.PLAYER_HEAD.parseMaterial() && make().getDurability() == (byte) 3) {
